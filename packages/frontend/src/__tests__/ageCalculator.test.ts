...
describe('calculateAge', () => {
  ...
  it('should account for today being before the birth date in "YYYYMMDD" format', () => {
    ...
    const expectedAge = today.getMonth() + 1 < parseInt(birthDate.substring(4, 6), 10) ||
      (today.getMonth() + 1 === parseInt(birthDate.substring(4, 6), 10) && today.getDate() < parseInt(birthDate.substring(6, 8), 10))
      ? 24 : 25;
